  ...
  <div class="w-192 mx-auto">
    ...
    <div class="mt-8">
      ...
      <form action="{{ route('contact') }}" method="POST">
        @csrf
        <div class="mb-4">
          <label for="name" class="block text-left p-1 my-1 font-medium">Name<span class="text-white text-xs bg-yellow-400 mx-2 py-1 px-2">必須</span></label>
        ...
        <div class="mb-4">
          <label for="email" class="block text-left p-1 my-1 font-medium">E-mail<span class="text-white text-xs bg-yellow-400 mx-2 py-1 px-2">必須</span></label>
        ...
        <div class="mb-4">
          <label for="body" class="block text-left p-1 my-1 font-medium">Contact Description<span class="text-white text-xs bg-yellow-400 mx-2 py-1 px-2">必須</span></label>
        ...
        <div class="text-center">
            ...
            <button class="mt-6 text-white font-semibold leading-none bg-blue-600 hover:bg-blue-700 rounded py-4 px-12" type="submit">Send</button>
        </div>
      </form>
    </div>
  </div>
