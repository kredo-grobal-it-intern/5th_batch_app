          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="list-group text-center">
                <a class="list-group-item list-group-item-action" rel="nofollow" data-method="POST" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
                <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">{{ csrf_field() }}</form>
                <a class="list-group-item list-group-item-action" data-dismiss="modal" href="#">Cancel</a>
              </div>
            </div>
          </div>
        </div>
