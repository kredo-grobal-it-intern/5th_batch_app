    ...
    <section class="my-5 mx-5" style="max-width: 23rem;">
        ...
        <div class="card map-card ">
            ...
            {{-- <div class="card-body closed px-0">
                ...
                <div class="bg-dark px-4 pb-4 pt-3" style="height: 500px">
